    ...
    >
      <Row className="text-center space-y-16" justify="center">
        ...
        <Col xs={24} md={12} className={`${width < 900 && "px-8"}`}>
          <Timeline mode="alternate" className="!text-biscuit !text-base">
            {experience.map((data, idx) => (
              ...
              >
                ...
                <p className="text-sm text-white">{data.company}</p>
                <p className="text-sm text-justify">
                  <ReadMore text={data.jobDesc} maxLength={60} />
                </p>
              </Timeline.Item>
            ))}
          </Timeline>
